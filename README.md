...
- **Authentication** and **role-based access control** using a jsonwebtoken.
- **Roles**:
...
- **Description**: This endpoint is used to log a user out of the system. After this, token no longer works, it will be considered invalid.
